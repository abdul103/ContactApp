...
/**
 * Servlet implementation class SearchByNumberServlet
 */
public class SearchByNumberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchByNumberServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//pw.print("seach by number");
		
		String number =request.getParameter("number");
		 MyContactAppDao dao = new MyContactAppDao();
		 
			List<NewContactBean> al =dao.searchByNumber(number);
			
			pw.print("<html><head><title>allContact</title></head><body style='background-color:palegreen;text-align:center'>");
